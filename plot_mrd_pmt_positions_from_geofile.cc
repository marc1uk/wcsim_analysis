...
t->Draw("wcsimrootgeom.fMRDPMTArray[].fPosition[0]:wcsimrootgeom.fMRDPMTArray[].fPosition[1]:wcsimrootgeom.fMRDPMTArray[].fPosition[2]","","same")
t->Draw("wcsimrootgeom.fFACCPMTArray[].fPosition[0]:wcsimrootgeom.fFACCPMTArray[].fPosition[1]:wcsimrootgeom.fFACCPMTArray[].fPosition[2]","","same")
//TCanvas c1
//c1.cd()
