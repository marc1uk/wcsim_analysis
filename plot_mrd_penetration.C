...
void truthtracks(){
	...
	TFile* outfile = new TFile("MRDpenetration.root","RECREATE");
	outfile->cd();
	...
	TH2D* penetrationcmvsenergyall = new TH2D("penetrationcmvsenergyall","Muon MRD Penetration vs Energy (All Muons)",100,0,3000,100,0,300);
	TH2D* penetrationhiststopall = new TH2D("penetrationhiststopall","Muon MRD Penetration vs Energy (Stopping Muons)",100,0,3000,100,0,300);
	// split into angles
	TH2D* penetrationhiststop1 = new TH2D("penetrationhiststop1","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 1/5*(Pi/2))",100,0,1500,100,0,150);
	TH2D* penetrationhiststop2 = new TH2D("penetrationhiststop2","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 2/5*(Pi/2))",100,0,1500,100,0,150);
	TH2D* penetrationhiststop3 = new TH2D("penetrationhiststop3","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 3/5*(Pi/2))",100,0,1500,100,0,150);
	TH2D* penetrationhiststop4 = new TH2D("penetrationhiststop4","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 3.5/5*(Pi/2))",100,0,1500,100,0,150);
	TH2D* penetrationhiststop5 = new TH2D("penetrationhiststop5","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 4/5*(Pi/2))",100,0,1500,100,0,150);
	TH2D* penetrationhiststop6 = new TH2D("penetrationhiststop6","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 4.5/5*(Pi/2))",100,0,1500,100,0,150);
	TH2D* penetrationhiststop7 = new TH2D("penetrationhiststop7","Muon MRD Penetration vs Energy (Stopping Muons with Angle < 5/5*(Pi/2))",100,0,1500,100,0,150);
	...
	TH2D* penetrationhistpeneall = new TH2D("penetrationhistpeneall","Muon MRD Penetration vs Energy (Fully Penetrating Muons)",100,0,3000,100,0,300);
	TH2D* penetrationhistotherall = new TH2D("penetrationhistotherall","Muon MRD Penetration vs Energy (Side Exiting Muons)",100,0,3000,100,0,300);
...
//#endif
		...
		if(muonstopsinMRD){ penetrationhiststopall->Fill(muonenergy,mrdpenetrationcm);
			// split into angular bins
		     if(muonangle<((TMath::Pi()/2.)*(1./5.))){ penetrationhiststop1->Fill(muonenergy,mrdpenetrationcm); }
		else if(muonangle<((TMath::Pi()/2.)*(2./5.))){ penetrationhiststop2->Fill(muonenergy,mrdpenetrationcm); }
		else if(muonangle<((TMath::Pi()/2.)*(3./5.))){ penetrationhiststop3->Fill(muonenergy,mrdpenetrationcm); }
		else if(muonangle<((TMath::Pi()/2.)*(3.5/5.))){penetrationhiststop4->Fill(muonenergy,mrdpenetrationcm); }
		else if(muonangle<((TMath::Pi()/2.)*(4./5.))){ penetrationhiststop5->Fill(muonenergy,mrdpenetrationcm); }
		else if(muonangle<((TMath::Pi()/2.)*(4.5/5.))){penetrationhiststop6->Fill(muonenergy,mrdpenetrationcm); }
		else if(muonangle<((TMath::Pi()/2.)*(5./5.))){ penetrationhiststop7->Fill(muonenergy,mrdpenetrationcm); }
		}
		else if(muonrangesoutMRD) penetrationhistpeneall->Fill(muonenergy,mrdpenetrationcm);
		else if(muonentersMRD) penetrationhistotherall->Fill(muonenergy,mrdpenetrationcm);
...
//		thepaddleeffhist.SetBinContent(thepaddleeffhist.FindBin(projectedxposition),paddleefficiency.at(pmtit));
	...
	penetrationhiststop1->SetTitle("MRD Penetration vs Muon Energy for Varying Incident Angle");
	...
	penetrationgraph->GetYaxis()->SetTitle("Depth per Unit Energy [cm/MeV]");
